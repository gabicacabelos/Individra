        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none md:hidden" style={{ contain: 'strict' }}>
            ...
            <svg className="absolute inset-0 w-full h-full" style={{ transform: 'translateZ(0)' }}>
                <defs>
                    <linearGradient id="sGrad1" x1="0%" y1="0%" x2="100%" y2="100%">
                        ...
                        <stop offset="100%" stopColor="rgba(183,179,176,0.15)" />
                    </linearGradient>
                </defs>
                ...
                {/* Líneas conectoras */}
                <line x1="10%" y1="25%" x2="35%" y2="45%" stroke="rgba(200,66,20,0.2)" strokeWidth="1" strokeDasharray="4 4">
                    <animate attributeName="stroke-dashoffset" values="0;16" dur="3s" repeatCount="indefinite"/>
                </line>
                <line x1="65%" y1="35%" x2="90%" y2="55%" stroke="rgba(183,179,176,0.2)" strokeWidth="1" strokeDasharray="4 4">
                    <animate attributeName="stroke-dashoffset" values="0;-16" dur="3s" repeatCount="indefinite"/>
                </line>
            </svg>
            ...
            <style jsx>{`
                .services-orb-1 {
                    ...
                    height: 200px;
                    border-radius: 50%;
                    background: radial-gradient(circle, rgba(200,66,20,0.12) 0%, transparent 70%);
                    left: -50px;
                    top: 15%;
                ...
                .services-orb-2 {
                    ...
                    height: 160px;
                    border-radius: 50%;
                    background: radial-gradient(circle, rgba(183,179,176,0.08) 0%, transparent 70%);
                    right: -40px;
                    bottom: 25%;
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none md:hidden" style={{ contain: 'strict' }}>
            <svg className="absolute inset-0 w-full h-full opacity-25" style={{ transform: 'translateZ(0)' }}>
                <defs>
                    <linearGradient id="cGrad" x1="0%" y1="0%" x2="100%" y2="100%">
                        ...
                        <stop offset="100%" stopColor="rgba(183,179,176,0.2)"/>
                    </linearGradient>
                    <pattern id="cGrid" width="60" height="60" patternUnits="userSpaceOnUse">
                        <path d="M 60 0 L 0 0 0 60" fill="none" stroke="rgba(183,179,176,0.08)" strokeWidth="0.5"/>
                    </pattern>
                </defs>
                ...
                {/* Celdas que brillan */}
                <rect x="20%" y="30%" width="60" height="60" fill="rgba(200,66,20,0.08)">
                    <animate attributeName="opacity" values="0;0.4;0" dur="4s" repeatCount="indefinite"/>
                </rect>
                <rect x="60%" y="60%" width="60" height="60" fill="rgba(183,179,176,0.08)">
            ...
            <style jsx>{`
                .catalog-corner {
                    ...
                    width: 24px;
                    height: 24px;
                    border-left: 1px solid rgba(200,66,20,0.4);
                    border-top: 1px solid rgba(200,66,20,0.4);
...
export function MobileFAQBackground() {
    return (
        <div className="absolute inset-0 overflow-hidden pointer-events-none md:hidden" style={{ contain: 'strict' }}>
            ...
            <svg className="absolute inset-0 w-full h-full" style={{ transform: 'translateZ(0)' }}>
                <text x="15%" y="25%" fill="rgba(200,66,20,0.12)" fontSize="20" fontWeight="bold">
                    ?
                    <animate attributeName="y" values="25%;22%;25%" dur="6s" repeatCount="indefinite"/>
                </text>
                <text x="50%" y="50%" fill="rgba(183,179,176,0.12)" fontSize="20" fontWeight="bold">
                    ?
                    <animate attributeName="y" values="50%;47%;50%" dur="7s" repeatCount="indefinite"/>
                </text>
                <text x="85%" y="75%" fill="rgba(200,66,20,0.12)" fontSize="20" fontWeight="bold">
                    ?
                    <animate attributeName="y" values="75%;72%;75%" dur="5s" repeatCount="indefinite"/>
                </text>

                {/* Puntos flotantes */}
                <circle cx="25%" cy="60%" r="1.5" fill="rgba(200,66,20,0.3)">
                    <animate attributeName="cy" values="60%;57%;60%" dur="5s" repeatCount="indefinite"/>
                </circle>
                <circle cx="75%" cy="35%" r="1.5" fill="rgba(183,179,176,0.3)">
            ...
            <style jsx>{`
                .faq-orb-1 {
                    ...
                    height: 180px;
                    border-radius: 50%;
                    background: radial-gradient(circle, rgba(200,66,20,0.1) 0%, transparent 70%);
                    left: -60px;
                    top: 10%;
